...
- (id)initWithScale:(unsigned)aScale colors:(NSDictionary *)aColors
{
	...
	imgview = [[NSImageView alloc] initWithFrame:frame];
...
- (void) drawRect:(NSRect)rect
{
	...
	// Brizzly on 2017.08.22 "http://jadegame.com/games/hp48/", "https://github.com/brizzly/sunhpgames"
	...
	[img2 drawInRect:dstRect fromRect:rect operation:NSCompositeCopy fraction:1.0];
	[img2 release];
}
...
//	NSRect r1 = CGRectMake(0, 0, [img size].width, [img size].height);
//	NSRect r2 = CGRectMake(dragPoint.x, dragPoint.y, dragRect.size.width, dragRect.size.height);
//	[dragImage drawInRect:r2 fromRect:r1 operation:NSCompositeCopy fraction:1.0];
}
